...
def get_dataset(opts):
    ...
    if opts.dataset == 'voc':
        ...
        train_dst = VOCSegmentation(root=opts.data_root, year=opts.year,
                                    image_set='train',divide_data=opts.divide_data, download=opts.download, transform=train_transform)
        val_dst = VOCSegmentation(root=opts.data_root, year=opts.year,
                                  image_set='val',divide_data=opts.divide_data, download=False, transform=val_transform)
        test_dst = VOCSegmentation(root=opts.data_root, year=opts.year,
                                  image_set='test',divide_data=opts.divide_data, download=False, transform=val_transform)
